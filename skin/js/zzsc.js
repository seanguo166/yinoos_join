...
(function(){
	...
	var a={ 
		...
		images:function(){ 
			a.obj.find("li").bind("click",function(){ 
				var src=$(this).attr("src");

				var cont = $(this).attr("title");
				var money = $(this).attr("money");

				$(this).siblings().attr("class",'brand_out');
				$(this).attr("class",'brand_over');

				$("#intro").html('详细');
				$("#intro").attr('href',money);
				$("#title").html(cont);
		...
		roll:{ 
			foward:function(step){ 
				var m=a.calculate.roll();
				a.obj.find("ul").animate({ "marginTop":m[0]-123*step},100);
			},
			next:function(step){ 
				var m=a.calculate.roll();
				a.obj.find("ul").animate({ "marginTop":m[0]+123*step},100)		
		...
		init:function(){ 
			...
			var img_first = a.obj.find("li:eq(0) img");
			
			var cont = img_first.attr("title");
			var money = img_first.attr("money");
		$("#intro").html('详细');
			$("#intro").attr('href',money);
			$("#title").html(cont);
